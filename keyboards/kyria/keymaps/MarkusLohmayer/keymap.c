...
[_B] = LAYOUT(
  ...
  KC_LALT , KC_Z    , KC_X    , KC_C    , KC_V    , KC_B    , TT(_A)  , KC_LEFT , KC_RGHT , KC_NO   , KC_N    , KC_M    , KC_COMM , KC_DOT  , KC_SLSH , KC_UP   ,
                                KC_NO   , KC_LCTL , KC_LSPO , KC_SPC  , TT(_L)  , TT(_R)  , KC_SPC  , KC_RSPC , KC_LGUI , KC_MUTE
),
[_L] = LAYOUT(
